...
func init() {
	Register(&Package{
		...
		Funcs: map[string]GoFuncSig{
			...
			"format_int": {GoName: "FormatInt", Params: []GoType{GoInt64, GoInt}, Returns: []GoType{GoString}, Doc: "Returns the string representation of i in the given base."},
			"parse_int":  {GoName: "ParseInt", Params: []GoType{GoString, GoInt, GoInt}, Returns: []GoType{GoInt64, GoError}, Doc: "Interprets a string in the given base and bit size."},
		},
	})
}

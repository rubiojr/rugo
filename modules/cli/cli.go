...
func init() {
	modules.Register(&modules.Module{
		...
		Funcs: []modules.FuncDef{
			...
			{Name: "args", Args: nil, Doc: "Return the positional arguments before any \"--\" separator."},
			{Name: "passthrough", Args: nil, Doc: "Return the opaque arguments after a \"--\" separator."},

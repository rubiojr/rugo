...
rats "http.get returns response hash with status_code, body, headers"
  script = <<~SCRIPT
    ...
    spawn web.listen(19301)
    time.sleep_ms(300)
    resp = http.get("http://localhost:19301/info")
...
rats "http.post returns response hash"
  script = <<~SCRIPT
    ...
    spawn web.listen(19302)
    time.sleep_ms(300)
    resp = http.post("http://localhost:19302/echo", "payload")
    puts(resp.status_code)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
...
rats "http.get non-200 status code accessible"
  script = <<~SCRIPT
    ...
    spawn web.listen(19303)
    time.sleep_ms(300)
    resp = http.get("http://localhost:19303/missing")
    puts(resp.status_code)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
  result = test.run("rugo run " + test.tmpdir() + "/test.rg")
...
rats "http.get sends custom headers"
  script = <<~SCRIPT
    ...
    spawn web.listen(19304)
    time.sleep_ms(300)
    headers = {"X-Custom" => "hello-rugo"}
    resp = http.get("http://localhost:19304/check", headers)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
  result = test.run("rugo run " + test.tmpdir() + "/test.rg")
...
rats "http.post sends custom headers"
  script = <<~SCRIPT
    ...
    spawn web.listen(19305)
    time.sleep_ms(300)
    headers = {"Authorization" => "Bearer token123"}
    resp = http.post("http://localhost:19305/check", "{}", headers)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
  result = test.run("rugo run " + test.tmpdir() + "/test.rg")
...
rats "http.put sends PUT request"
  script = <<~SCRIPT
    ...
    spawn web.listen(19306)
    time.sleep_ms(300)
    resp = http.put("http://localhost:19306/resource", "update-data")
    puts(resp.status_code)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
...
rats "http.patch sends PATCH request"
  script = <<~SCRIPT
    ...
    spawn web.listen(19307)
    time.sleep_ms(300)
    resp = http.patch("http://localhost:19307/resource", "partial-data")
    puts(resp.status_code)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
...
rats "http.delete sends DELETE request"
  script = <<~SCRIPT
    ...
    spawn web.listen(19308)
    time.sleep_ms(300)
    resp = http.delete("http://localhost:19308/resource")
    puts(resp.status_code)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
...
rats "http.delete sends custom headers"
  script = <<~SCRIPT
    ...
    spawn web.listen(19309)
    time.sleep_ms(300)
    headers = {"Authorization" => "Bearer secret"}
    resp = http.delete("http://localhost:19309/auth", headers)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
  result = test.run("rugo run " + test.tmpdir() + "/test.rg")
...
rats "http.put sends custom headers"
  script = <<~SCRIPT
    ...
    spawn web.listen(19310)
    time.sleep_ms(300)
    headers = {"X-Api-Key" => "key123"}
    resp = http.put("http://localhost:19310/auth", "{}", headers)
    puts(resp.body)
  SCRIPT
  test.write_file(test.tmpdir() + "/test.rg", script)
  result = test.run("rugo run " + test.tmpdir() + "/test.rg")

...
rats "pipe: native binary with pipes"
  result = test.run("rugo build rats/fixtures/pipe_binary.rg -o /tmp/rugo_pipe_binary")
  test.assert_eq(result["status"], 0)
...
rats "pipe: puts/print in mid-chain is compile error"
  result = test.run("rugo run rats/fixtures/pipe_void_mid_chain.rg")

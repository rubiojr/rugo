...
func init() {
	Register(&Package{
		...
		Funcs: map[string]GoFuncSig{
			...
			"mkdir_all":     {GoName: "MkdirAll", Params: []GoType{GoString, GoInt}, Returns: []GoType{GoError}, Doc: "Creates a directory path and all parents that do not exist."},
			...
			"read_file":     {GoName: "ReadFile", Params: []GoType{GoString}, Returns: []GoType{GoString, GoError}, Doc: "Reads and returns the contents of the named file."},
			"write_file":    {GoName: "WriteFile", Params: []GoType{GoString, GoString, GoInt}, Returns: []GoType{GoError}, Doc: "Writes data to the named file with the given permissions."},

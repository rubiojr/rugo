...
//
//go:embed bincache.go check_idents.go compiler.go codegen.go codegen_build.go codegen_expr.go codegen_func.go codegen_runtime.go codegen_scope.go codegen_stmt.go ext.go goast.go goprint.go infer.go types.go visitor.go
